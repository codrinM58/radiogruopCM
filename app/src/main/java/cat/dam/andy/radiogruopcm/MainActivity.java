package cat.dam.andy.radiogruopcm;
...
public class MainActivity extends Activity {
    // El color verde con el import me pone elcolor lima y no verde oscuro, por lo tanto al poner
    // backgroun y color lletra sale el lima.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // definimos cada opcion que es para poder utilizarlas luego abajo
        ...
        opcions.setOnCheckedChangeListener(new OnCheckedChangeListener() {
            @Override
            // para poner invisible o visible los botones segun le demos clic si opcion de letra o colores.
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                // radio button selecionat
